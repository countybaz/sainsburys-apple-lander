      ...
      <div className="px-4 py-4 sm:py-6">
        <div className="flex items-start gap-3 sm:gap-4 mb-6">
          <img 
            ...
            alt="App Icon" 
            className="w-16 h-16 sm:w-24 sm:h-24 rounded-xl sm:rounded-2xl shadow-lg flex-shrink-0"
          />
          <div className="flex-1 pt-1 min-w-0">
            <h1 className="text-lg sm:text-2xl font-semibold text-black mb-1 leading-tight">
              Sainsbury's Product Reviewer
            </h1>
            <p className="text-gray-600 text-sm sm:text-base mb-3 sm:mb-4 leading-snug">
              Get Rewards By Doing Deals👇
            </p>
            <a href="https://unlockrwrd.com/LwA1CaVCV" className="inline-block">
              <Button className="bg-blue-500 hover:bg-blue-600 text-white font-medium px-6 sm:px-8 py-2 sm:py-2.5 rounded-full text-sm sm:text-base">
                Apply Now
              </Button>
            </a>
          </div>
            ...
            <CardContent className="p-4 sm:p-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm sm:text-base text-black">Complete recommended Deals</span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-base sm:text-lg">💰</span>
                  <span className="text-sm sm:text-base text-black">Claim Your Reward!</span>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center gap-4 sm:gap-6">
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-light text-black mb-1">4.6</div>
                  <div className="text-xs sm:text-sm text-gray-500">out of 5</div>
                </div>
        ...
        <div className="mb-6 sm:mb-8">
          <Card className="shadow-sm border-gray-200 bg-white">
            <CardContent className="p-4 sm:p-5">
              <h2 className="text-base sm:text-lg font-semibold text-black mb-4 text-center">Live Feed</h2>
              <div className="border-2 border-green-500 rounded-lg p-3 bg-green-50">
                <p className="text-center text-black text-xs sm:text-sm leading-relaxed">
                  ...
                  <span className="text-green-600 font-semibold text-sm sm:text-base">{currentName}</span>{' '}
                  just claimed her
                  <br />
          ...
          <Card className="shadow-sm border-gray-200 bg-white">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                />
                <div>
                  <div className="text-xs sm:text-sm font-semibold text-black">Worked So Well!</div>
          ...
          <Card className="shadow-sm border-gray-200 bg-white">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                />
                <div>
                  <div className="text-xs sm:text-sm font-semibold text-black">I use this every week!</div>
