    ...
    fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Helvetica Neue", Arial, sans-serif'
      ...
      <div className="px-4 py-4 sm:py-6">
        <div className="flex items-start gap-3 sm:gap-4 mb-6">
          <img src="https://storage.googleapis.com/msgsndr/oj1UE5nldpqOWbC3r8GS/media/6727f1fc37cc55a8175537fe.png" alt="App Icon" className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl shadow-lg flex-shrink-0" />
            ...
            <CardContent className="p-4">
              ...
              <div className="mb-2">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-gray-500">Jun 02, 2025</span>
                </div>
              </div>
        ...
        <div className="-my-4">
          <div className="flex gap-2 overflow-x-auto pb-0">
            <img src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/oj1UE5nldpqOWbC3r8GS/media/fe48ceb8-4f26-42b5-a23a-3d7ba8603fe9.png" alt="App Preview 1" className="flex-shrink-0 w-20 h-36 rounded-lg object-contain" />
            <img src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/oj1UE5nldpqOWbC3r8GS/media/8c0aff3e-45bd-49a7-b70c-8d3ffa7dfa9b.png" alt="App Preview 2" className="flex-shrink-0 w-20 h-36 rounded-lg object-contain" />
            <img src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/oj1UE5nldpqOWbC3r8GS/media/61dba3bc-da7a-4a12-b512-a2ed19f1eb90.png" alt="App Preview 3" className="flex-shrink-0 w-20 h-36 rounded-lg object-contain" />
            <img src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/oj1UE5nldpqOWbC3r8GS/media/bbc484b5-34f0-461f-87ab-2dffe0c923b5.png" alt="App Preview 4" className="flex-shrink-0 w-20 h-36 rounded-lg object-contain" />
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex gap-3 overflow-x-auto pb-4 scrollbar-hide">
            <div className="flex-shrink-0">
              <img src="https://storage.googleapis.com/msgsndr/oj1UE5nldpqOWbC3r8GS/media/679e3a6abe5edce77835a875.png" alt="Screenshot 1" className="w-[calc(50vw-2rem)] max-w-40 h-auto aspect-[9/16] rounded-lg shadow-md object-cover" />
            </div>
            <div className="flex-shrink-0">
              <img src="https://storage.googleapis.com/msgsndr/oj1UE5nldpqOWbC3r8GS/media/679e3a6ae64e963e7a5e8026.png" alt="Screenshot 2" className="w-[calc(50vw-2rem)] max-w-40 h-auto aspect-[9/16] rounded-lg shadow-md object-cover" />
            </div>
          </div>
        </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <div className="space-y-2">
                    ...
                    stars: 1,
                    width: '13%'
                  }].map((rating, index) => <div key={index} className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-0.5 flex-shrink-0">
                          {Array.from({
                        length: 5
                      }, (_, i) => <span key={i} className={`text-xs ${i < rating.stars ? 'text-black' : 'text-gray-300'}`}>
                              ★
                            </span>)}
                        </div>
                        <div className="flex-1 h-1.5 bg-gray-200 rounded-full overflow-hidden ml-2">
                          <div className="h-full bg-black rounded-full transition-all duration-300" style={{
                        width: rating.width
                      }} />
                        </div>
                      </div>)}
        ...
        <div className="space-y-3">
          <Card className="shadow-sm border-gray-200 bg-white">
            <CardContent className="p-3">
              <div className="flex items-center gap-3 mb-2">
                <img src="https://i.pinimg.com/236x/d0/9a/38/d09a38017048ec506b4564d5048352c1.jpg" alt="Profile" className="w-5 h-5 rounded-full" />
                <div>
          ...
          <Card className="shadow-sm border-gray-200 bg-white">
            <CardContent className="p-3">
              <div className="flex items-center gap-3 mb-2">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJm1VcPK75fg8bFTEJ1c4-7rI84xdHK-OhAw&s" alt="Profile" className="w-5 h-5 rounded-full" />
                <div>
